...
const CACHE_BYPASS_TIMESTAMP_ALIGNMENT = 15 * 60 * 1000; // 15 minutes
...
function getFeedsByChannelID(channelID) {
    ...
    const cacheByPassParam = `&ctsmp=${timeStamp - (timeStamp % CACHE_BYPASS_TIMESTAMP_ALIGNMENT)}`;
    const url = FEEDS_URL + 'channel_id=' + channelID + cacheByPassParam;
